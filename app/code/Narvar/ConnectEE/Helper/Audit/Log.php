...
class Log extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * Method to get the Existing Non Successful Pushed Records from Log table for speicfic Order Id
     *
     * @param int $orderId
     * @return boolean
     */
    public function hasFailures($orderId)
    {
        $auditLogs = $this->auditLogCollectionFactory->create();
        $auditLogs->addOrderIdFilter($orderId)->addNonProcessedFilter();
